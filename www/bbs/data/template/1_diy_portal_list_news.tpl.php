<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_news');
0
|| checktplrefresh('./template/default/portal/list_news.htm', './template/default/common/header.htm', 1376357081, 'diy', './data/template/1_diy_portal_list_news.tpl.php', './template/default', 'portal/list_news')
|| checktplrefresh('./template/default/portal/list_news.htm', './template/default/common/footer.htm', 1376357081, 'diy', './data/template/1_diy_portal_list_news.tpl.php', './template/default', 'portal/list_news')
|| checktplrefresh('./template/default/portal/list_news.htm', './template/default/common/header_common.htm', 1376357081, 'diy', './data/template/1_diy_portal_list_news.tpl.php', './template/default', 'portal/list_news')
|| checktplrefresh('./template/default/portal/list_news.htm', './template/default/common/pubsearchform.htm', 1376357081, 'diy', './data/template/1_diy_portal_list_news.tpl.php', './template/default', 'portal/list_news')
;
block_get('25,25');?>
...
<div id="wp" class="wp"><?php $list = array();?><?php $wheresql = category_get_wheresql($cat);?><?php $list = category_get_list($cat, $wheresql, $page);?><?php echo adshow("text/wp a_t");?><style id="diy_style" type="text/css"></style>
<div class="wp">
<!--[diy=diy1]--><div id="diy1" class="area"></div><!--[/diy]-->
</div>
<style type="text/css">
.listNews{margin-bottom: 50px;}
.listNews h4{font-size: 18px;font-weight: bold;clear: both;margin-bottom: 10px;}
.listNews li{padding: 10px 15px 15px;margin-bottom: 15px;overflow: hidden;zoom:1;}
.listNews li:hover{background: #f4f4f4;}
.listNews h4 a{color: #242424;}
.simg{float: left;margin-right: 15px;}
.simg,.simg img{width: 190px;height: 120px;}
.newsInfo{overflow: hidden;zoom:1;}
.newsInfo a{color: #2f90cb;}
.newsInfo p{line-height: 30px;height: 90px;border-bottom: 2px solid #fff;margin-bottom: 8px;}
.newsInfo div{height: 16px;line-height: 16px;}
.newsInfo div span{border-right: 1px solid #000;margin-right: 10px;padding-right: 10px;}
.newsInfo div span:last-child{border-right: 0;}
.newsInfo div span a{margin-right: 5px;}
.tit{border-bottom: 1px solid #dcdcdc;height: 30px;margin-bottom: 15px;margin-bottom: 10px;}
.tit h3{border-bottom:5px solid #18b3f0;position: relative;bottom: -1px;_bottom: -2px;padding-right: 15px;float: left;font-size: 18px;color: #18b3f0;}
.flight li {
    line-height: 24px;
    white-space: nowrap;
    width: 220px;
...
.btag,.flight{margin-bottom: 10px;}
.btag a{display: inline-block;margin: 0 5px;color: #000;}
.btag .hottag1{color: #ff6600;font-size:30px;}
.btag .hottag2{font-size: 24px;color: #18b3f0;}
.btag .hottag3{font-size: 18px;color: #8c8c8c;}
</style>
...
<?php } ?>
<div class="bm_c xld">
<ul class="listNews"><?php if(is_array($list['list'])) foreach($list['list'] as $value) { ?><?php $highlight = article_title_style($value);?><li>
<h4><a href="portal.php?mod=view&amp;aid=<?php echo $value['aid'];?>" target="_blank"><?php echo $value['title'];?></a></h4>
<?php if($value['pic']) { ?>
<a href="portal.php?mod=view&amp;aid=<?php echo $value['aid'];?>" target="_blank"  class="simg"><img src="<?php echo $value['pic'];?>" alt="<?php echo $value['title'];?>" /></a>
<?php } else { ?>
<a href="portal.php?mod=view&amp;aid=<?php echo $value['aid'];?>" target="_blank"  class="simg"><img src="static/image/common/nophoto.gif" alt="<?php echo $value['title'];?>" /></a>
<?php } ?>
<div class="newsInfo">
<p><?php echo $value['summary'];?><a href="portal.php?mod=view&amp;aid=<?php echo $value['aid'];?>" target="_blank" >[详细]</a></p>
<div><span><a href="home.php?mod=space&amp;uid=<?php echo $value['uid'];?>"><?php echo $value['username'];?></a>发表于<?php echo $value['dateline'];?></span><span>访问：<?php echo get_article_num($value['aid'],'viewnum'); ?></span><span><?php echo get_article_num($value['aid'],'commentnum'); ?>条评论</span></div>
</div>
</li>
<?php } ?>
</ul>
...
<ul class="flight"><?php block_display('25');?></ul>
</div>
<div>
<div class="tit f_c">
<h3>热门标签</h3>						
...
<div class="btag">
<script src="api.php?mod=hottag" type="text/javascript"></script>
</div>
</div>			
<div>
<div class="tit f_c">
