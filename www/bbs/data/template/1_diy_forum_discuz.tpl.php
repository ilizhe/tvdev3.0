...
0
|| checktplrefresh('data/diy/./template/default//forum/discuz.htm', './template/default/common/header.htm', 1376357066, 'diy', './data/template/1_diy_forum_discuz.tpl.php', 'data/diy/./template/default/', 'forum/discuz')
|| checktplrefresh('data/diy/./template/default//forum/discuz.htm', './template/default/common/footer.htm', 1376357066, 'diy', './data/template/1_diy_forum_discuz.tpl.php', 'data/diy/./template/default/', 'forum/discuz')
|| checktplrefresh('data/diy/./template/default//forum/discuz.htm', './template/default/common/header_common.htm', 1376357066, 'diy', './data/template/1_diy_forum_discuz.tpl.php', 'data/diy/./template/default/', 'forum/discuz')
|| checktplrefresh('data/diy/./template/default//forum/discuz.htm', './template/default/common/pubsearchform.htm', 1376357066, 'diy', './data/template/1_diy_forum_discuz.tpl.php', 'data/diy/./template/default/', 'forum/discuz')
;
block_get('191');?>
...
<?php if(empty($gid)) { ?>
<div class="wp">
<!--[diy=diy1]--><div id="diy1" class="area"><div id="frameHWRZWT" class="frame move-span cl frame-1-1"><div id="frameHWRZWT_left" class="column frame-1-1-l"><div id="frameHWRZWT_left_temp" class="move-span temp"></div><?php block_display('191');?></div><div id="frameHWRZWT_center" class="column frame-1-1-r"><div id="frameHWRZWT_center_temp" class="move-span temp"></div></div></div><div id="frame9Ds9hk" class="gonggao frame move-span cl frame-1"><div id="frame9Ds9hk_left" class="column frame-1-c"><div id="frame9Ds9hk_left_temp" class="move-span temp"></div></div></div></div><!--[/diy]-->
</div>
<?php } ?>
...
<div class="bm lk">
<div class="bm_h cl">
<h2><a href="<?php echo $_G['config']['url']['www'];?>/friendlink.html">友情链接</a></h2>
</div>
