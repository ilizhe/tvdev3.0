...
$_config = array();
// ----------------------------  CONFIG URL  ----------------------------- //
$_config['url']['www'] = 'http://www.ltest.com';
$_config['url']['login'] = 'http://member.ltest.com/?mod=member&act=loggin';
$_config['url']['reg'] = 'http://member.ltest.com/?mod=register';
$_config['url']['bbs'] = 'http://www.ltest.com/bbs';
...
$_config['db']['1']['dbname'] = 'dev_mm_tt';
$_config['db']['1']['tablepre'] = 'bbs_';
$_config['db']['common']['slave_except_table'] = '';

// --------------------------  CONFIG MEMORY  --------------------------- //
$_config['memory']['prefix'] = 'YrfXrm_';
...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'o49w_';
$_config['cookie']['cookiedomain'] = '';
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = '9ad09403y9XfMlaP';
